...
set(CMAKE_CXX_COMPILER_ARG1 " -Ofast -fomit-frame-pointer -ffast-math -fno-signed-zeros -m64 -m32 -mmmx -msse  -funroll-loops")
...
set(CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES "/usr/local/opt/openblas/lib;/usr/local/opt/qt/lib;/usr/local/opt/icu4c/lib;/usr/local/opt/bison/lib;/usr/local/opt/readline/lib;/usr/local/opt/gettext/lib;/usr/local/opt/libxml2/lib;/usr/local/opt/libpng/lib;/usr/local/opt/zlib/lib;/usr/local/opt/openssl@1.1/lib;/usr/lib;/usr/local/lib")
